...
public class WeatherMain {
    ...
    public String toString() {
        return "WeatherMain [temp=" + temp + ", feels_like=" + feels_like + ", temp_min=" + temp_min + ", temp_max="
    ...
    public WeatherMain(Double temp, Double feels_like, Double temp_min, Double temp_max, Integer pressure,
            Integer humidity, Integer sea_level, Integer grnd_level) {
        this.temp = temp;
        this.feels_like = feels_like;
        this.temp_min = temp_min;
        this.temp_max = temp_max;
